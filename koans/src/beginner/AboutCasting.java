...
public class AboutCasting {
    ...
    public void classCasting() {
        try {
            //The object class does not have this method, but the granparent class does:
            //Object o = new Object();
    ...
    public void complicatedCast() {
        ...
        Parent parentReference = (Parent) parent;
        assertEquals("TPS reports don't even have a cover letter!", parentReference.complain());
    }
