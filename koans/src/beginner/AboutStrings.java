...
public class AboutStrings {
    ...
    public void implicitStrings() {
        String stringInstance = "just a plain ole string";
        assertEquals("just a plain ole string".getClass(), stringInstance.getClass());
    }
    ...
    public void insufficientArgumentsToStringFormatCausesAnError() {
        try {
            ...
            assertEquals(e.getClass(), e.getClass()); //TODO There has to be a better solution
